...
if ($conf->banque->enabled)
{
    ...
    else
    {
        ...
        {
            print '<a href="'.$_SERVER['PHP_SELF'].'?action=set_BANK_ASK_PAYMENT_BANK_DURING_ASKPRICESUPPLIER&amp;value=1">'.'<i class="fa fa-toggle-off" title="Disabled"></i>'.'</a>';
        }
        else
        {
            print '<a href="'.$_SERVER['PHP_SELF'].'?action=set_BANK_ASK_PAYMENT_BANK_DURING_ASKPRICESUPPLIER&amp;value=0">'.'<i class="fa fa-toggle-on" title="Enabled"></i>'.'</a>';
        }
    }
    print '</td></tr>';
}
